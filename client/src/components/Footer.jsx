  ...
  return (
    ...
    <footer className="mt-32 px-6 md:px-16 lg:px-24 xl:px-32 w-full text-sm text-slate-500 bg-white pt-10">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-14">
                    ...
                    <div className="flex flex-col lg:items-center lg:justify-center">
                        <div className="flex flex-col text-sm space-y-2.5">
                            ...
                            <a className="hover:text-slate-600 transition" href="#">Careers<span className="text-xs text-white bg-indigo-600 rounded-md ml-2 px-2 py-1">
                                We're hiring!</span></a>
                    ...
                    <div>
                        ...
                        <div className="text-sm space-y-6 max-w-sm">
                            ...
                            <div className="flex items-center justify-center gap-2 p-2 rounded-md bg-indigo-50">
                                <input className="focus:ring-2 bg-white ring-indigo-600 outline-none w-full max-w-64 py-2 rounded px-2" type="email" 
                ...
                <p className="py-4 text-center border-t mt-6 border-slate-200">
                    Copyright 2026 © <span className="text-indigo-600">Hiten</span>. All Right Reserved.
                </p>
            </footer>
    </>
  )
